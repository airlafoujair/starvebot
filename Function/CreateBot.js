                ...
                if (a !== false && mode !== "book") {
                    ...
                    if (smt.includes("wss://")) {
                        ...
                        if (smt.includes("eu")) {
                            ...
                            linke += `frankfurtrand.starve.io/server-eu-${smt.includes("f") ? "forest-" : smt.includes("v") ? "vampire-" : smt.includes("z") ? "zombie-" : ""}${smt[smt.includes("f") || smt.includes("v") || smt.includes("z") ? 3 : 2]}`
                            ...
                            linke += `torontorand.starve.io/server-na-${smt.includes("f") ? "forest-" : smt.includes("v") ? "vampire-" : smt.includes("z") ? "zombie-" : ""}${smt[smt.includes("f") || smt.includes("v") || smt.includes("z") ? 3 : 2]}`
                            ...
                            linke += `singaporerand.starve.io/server-as${smt.includes("f") ? "-forest-" : smt.includes("v") ? "-vampire-" : smt.includes("z") ? "-zombie-" : ""}${smt[smt.includes("f") || smt.includes("v") || smt.includes("z") ? 3 : 2]}`
                        } else if (smt.includes("wa")) {
                            linka += `fremont${rand}.starve.io/server-wa`
                            linke += `fremontrand.starve.io/server-wa`
                        } else if (smt.includes("au")) {
                            linka += `sydney${rand}.starve.io/server-au1`
                            linke += `sydneyrand.starve.io/server-au1`
                        }
                    }
                }
                                            ...
                                            case "book":
                                                let booky = setInterval(() => {
                                                    ...
                                                    if (Date.now() - dataint > 2000) {
                                                        dataint = Date.now()
                                                        Sock.send(JSON.stringify([0, `kill yourself`]))
                                                    }
                                                }, 1000 / 60)
                            ...
                            default:
                                ...
                                switch (mese[0]) {
                                    ...
                                    case 18:
                                        ...
                                        lastempty = lasttree
                                        Sock.send(JSON.stringify([0, `🎄${(lastempty && lastempty[1] && lastempty[1] == "s") ? "._." : "._."} `]))
                                        break;
                                    case 36:
...
axios.get("https://api.proxyscrape.com/v2/account/datacenter_shared/proxy-list?auth=e2fj8l61sdmrxpbr8h3l&type=getproxies&country[]=all&protocol=http&format=normal&status=all").then(res => {
